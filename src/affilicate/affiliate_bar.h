...
protected:
	...
	SDL_FColor color_high_ = { 0,1,0,1 };//绿
	SDL_FColor color_mid_ = { 1,0.65,0,1 };//橙
	SDL_FColor color_low_ = { 1,0,0,1 };//红

public:
	static AffiliateBar* addAffiliateBarChild(ObjectScreen* parent,
		glm::vec2 size, Anchor anchor = Anchor::CENTER);
